  ...
  auth: {
    ...
    strategies: {
      local: {
        ...
        endpoints: {
          login: { url: 'https://api.blackcarrack.tech/user/login', method: 'post', propertyName:'token' },
          logout: { url: 'https://api.blackcarrack.tech/user/logout', method: 'delete' },
          user: { url: 'https://api.blackcarrack.tech/user/profile', method: 'get',propertyName:'user'}
        }
      ...
      admin: {
        ...
        endpoints: {
          login: { url: 'https://api.blackcarrack.tech/admins/login', method: 'post', propertyName:'token' },
          logout: { url: 'https://api.blackcarrack.tech/admins/logout', method: 'delete' },
          user: { url: 'https://api.blackcarrack.tech/admins/admin', method: 'get',propertyName:false}
        }
        , tokenName:'auth-token'
      },
